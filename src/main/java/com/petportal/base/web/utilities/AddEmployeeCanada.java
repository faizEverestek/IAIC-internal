...
public class AddEmployeeCanada {

    private WebDriver driver = null;
    private final WebDriverWait wait;

    public AddEmployeeCanada(WebDriver driver) {
        this.driver = driver;
    ...
    private void addNewEmployee() {
        ...
        sendKeysToElement(By.xpath("(//input[@id='address.zipcode'])[1]"), "M5V 3L9");
    ...
    private void createEnrollStep1() throws InterruptedException {
        ...
        clickElement(By.xpath("//*[text()='Bavarian Hound']"));
    ...
    private void createEnrollStep3() throws InterruptedException {
        ...
        clickElement(By.xpath("//input[@id='agreeCASL']"));
        try {
