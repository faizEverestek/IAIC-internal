...
public class GroupCreatorQA2 extends CSVModifier {

    public static String newGroupName2 = getLatestGroupName();
    ...
    public GroupCreatorQA2(WebDriver driver) {
        this.driver = driver;
    ...
    public String normalGroupCreation(String groupType) throws Exception {
        ...
        String groupNumber = configureGroupStep2(newGroupName2);
        configureGroupStep3();
        configureGroupStep4(newGroupName2);
        configureGroupStep5();
        verifyGroupCreated(newGroupName2);
        activateGroupStep2();
        activateGroupStep3();
        activateGroupStep4();
        activateGroupStep5(newGroupName2, groupType);
        verifyGroupActivated(newGroupName2);
        return groupNumber;
    }
    ...
    private void configureGroupStep1(String groupType) throws InterruptedException {
        ...
        switch (groupType.toLowerCase()) {
            case "iaic administered":
                    clickElement(By.xpath("//*[text()='PTZ Administered']"));
                    clickElement(By.xpath("//input[@aria-label='Group MGA']"));
                    clickElement(By.xpath("//*[text()='PTZ/Sodaco']"));
                    break;
            case "ben admin administered":
                clickElement(By.xpath("//*[text()='Ben Admin Administered']"));
                clickElement(By.xpath("//label[@for='benAdminId']/following-sibling::div[1]"));
                sendKeysToElement(By.xpath("(//input[@aria-autocomplete='list'])[2]"), "Automation PDBA");
                Thread.sleep(10000);
            ...
            case "ben admin administered (post enrollment not included)":
                clickElement(By.xpath("//*[text()='Ben Admin Administered']"));
                clickElement(By.xpath("//label[@for='benAdminId']/following-sibling::div[1]"));
        ...
        sendKeysToElement(By.xpath("//input[@aria-label='Business Number']"), "123456789");
    ...
    private String configureGroupStep2(String newGroupName) {
        waitForPageToLoad();
        sendKeysToElement(By.xpath("//input[@id='sicCode']"), "123444");
        ...
        sendKeysToElement(By.xpath("//input[@aria-label='City']"), "Toronto");
        clickElement(By.xpath("//label[@for='locations[0].address.state']/following-sibling::div[1]"));
        clickElement(By.xpath("//*[text()='Ontario']"));
        sendKeysToElement(By.xpath("//input[@id='locations[0].address.zipcode']"), "M5V 3L9");
...
//        sendKeysToElement(By.xpath("//input[@id='isFirstFollowingWaitingPeriod']"), "");
    ...
    private void configureGroupStep5() throws InterruptedException {
        Thread.sleep(5000);
        WebElement elemet = driver.findElement(By.xpath("//input[@aria-label='Use company address for billing address']"));
        if(elemet.isDisplayed()){
            elemet.click();
            System.out.println(elemet.isDisplayed());
        }
        sendKeysToElement(By.xpath("//input[@id='phoneNumber']"), "0987654321");
        ...
        clickElement(By.xpath("//*[text()='Cheque']"));
...
//        clickElement(By.xpath("//div[text()='Generate Payroll Cycle']"));
    ...
    private void activateGroupStep2() {
        ...
        WebElement addPlanButton = driver.findElement(By.xpath("//*[text()='Add Plan']"));
        Actions actions = new Actions(driver);
        actions.moveToElement(addPlanButton).click().perform();
        ...
        clickElement(By.xpath("(//input[@aria-label='Inherited Condition Rider'])[1]"));
    ...
    private void activateGroupStep5(String newGroupName, String groupType) throws Exception {
        waitForPageToLoad();
        clickElement(By.xpath("(//div[@class='sc-bczRLJ cpAnrB'])[2]"));
        clickElement(By.xpath("//*[text()='12']"));
        modifyFile("src/test/testData/RatingExport.csv", "RatingExport", List.of("GroupName"), () -> newGroupName);
        uploadToElement(By.xpath("//input[@class='filepond--browser']"),"src/test/testData/RatingExport.csv");
        Thread.sleep(45000);
        clickElement(By.xpath("//div[text()='Next']"));
        Thread.sleep(5000);
        clickElement(By.xpath("//div[text()='Next']"));
